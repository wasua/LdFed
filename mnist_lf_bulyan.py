...
def mnistLfbulyan(number_of_samples,iteration_num,hostile_node_percentage,neighbors,is_cnn,is_noniid,is_organized):
    ...
    return [accList, 'bulyan', lossList,predictAccList]
