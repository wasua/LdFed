...
def mnistByzAfred(number_of_samples,iteration_num,hostile_node_percentage,is_cnn,is_noniid,is_organized):
    ...
    for iteration in range(iteration_num):
        ...
        meanParameterList=tn.getParameterMeanForNormalNode(normalNodeList,model_dict,device)
        ...
        thresholds = pd.concat([thresholds, iteration_threshold]) #获取不同参数上下限
    ...
    return [list(test_accuracies_of_each_iteration),"arfed",test_loss_of_each_iteration]
