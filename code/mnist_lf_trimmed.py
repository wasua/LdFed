...
def mnistLfTrimmed(number_of_samples,iteration_num,hostile_node_percentage,is_cnn,is_noniid,is_organized):
    ...
    for iteration in range(iteration_num):
        ...
        main_model = tn.set_trimmed_mean_weights_as_main_model_weights_and_update_main_model(main_model,
                                                                                             model_dict,
                                                                                             number_of_samples,
    ...
    return [accList, 'trimmed', lossList]
