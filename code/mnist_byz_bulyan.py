...
def mnistByzbulyan(participates, iteration_num,hostile_node_percentage,neighbors,is_cnn,is_noniid,is_organized):
    ...
    for iteration in range(iteration_num):
        ...
        main_model=main_model=tn.bulyan(main_model,model_dict,number_of_samples,neighbors,device)
        #聚合全局模型
        #验证模型准确率
    ...
    return [list(test_accuracies_of_each_iteration),"bulyan",test_loss_of_each_iteration]
