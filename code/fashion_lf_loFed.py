...
def fashionmnistFlipLofed(number_of_samples,iteration_num,hostile_node_percentage,neighbors,is_noniid,is_organized):
    ...
    testAcc,testLoss,predictAccList=[],[],[]
    ...
    for iteration in range(iteration_num):
        ...
        normalNodeList, hostileNodeList1 = tn.getParameterFrameAndHostileNode(main_model, model_dict, neighbors)
        predictNodeList = []
        for node in hostileNodeList1:
            predictNodeList.append(int(node[5:]))
        predictNodeList.sort()
        print("hostile_nodes:", hostileNodeList)
        print("-----predictNodeList:", predictNodeList)
    ...
    return [testAcc, "loFed", testLoss,predictAccList]
