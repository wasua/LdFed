...
def fashionmnistByzBarfed(number_of_samples,iteration_num,hostile_node_percentage,is_noniid,is_organized):
    ...
    model_dict, optimizer_dict, criterion_dict = tn.create_model_optimizer_criterion_dict_for_fashion_mnist(number_of_samples, learning_rate,
    ...
    return [testAcc, "barfed", testLoss]
