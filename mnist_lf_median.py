...
def mnistLfMedian(number_of_samples,iteration_num,hostile_node_percentage,is_cnn,is_noniid,is_organized):
    ...
    return [list(test_accuracies_of_each_iteration), 'median',lossList]
