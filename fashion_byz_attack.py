...
def fashionmnistByzAttack(number_of_samples,iteration_num,hostile_node_percentage,is_noniid,is_organized):

    device = torch.device("cuda:0" if torch.cuda.is_available() else "cpu")
    print('             **********attack --', device,' **********')

    #number_of_samples = 4  # number of participants
    ...
    #is_organized = True
    #hostile_node_percentage = 0.10  # malicious participant ratio
    byzantine_mean = 0
    byzantine_std = 1
